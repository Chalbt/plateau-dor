    ...
    return (
        <div className="nos-services">
           <div className="nos-prestations">
                ...
                <p>Nous sommes fiers de proposer une gamme complète de services de traiteur pour répondre à tous vos besoins événementiels. Quelque soit l'évènement que vous planifiez, nous sommes là pour vous offrir une expérience culinaire exceptionnelle. Notre équipe expérimentée et passionnée met en avant des saveurs uniques et créatives, des ingrédients de qualité et des présentations soignées. Avec notre savoir-faire et notre attention aux détails, nous sommes déterminés à faire de chaque événement un succès mémorable.</p>
                <p className="commande">Découvrez notre prestation sur mesure : Commande à la carte en toute simplicité. Vous avez une envie particulière ou un événement à préparer rapidement ? Avec notre service de commande à la carte, vous pouvez composer votre menu personnalisé, directement par mail ou message. Faites votre choix parmi notre délicieuse sélection de plats et mets exquis. Nous mettons tout en œuvre pour préparer vos commandes dans un délai de 48 heures, vous garantissant ainsi une expérience culinaire fraîche, savoureuse et adaptée à vos envies. Faites confiance à Plateau d'Or pour une expérience gastronomique sur mesure, conçue pour répondre à vos besoins uniques.</p>
           </div>
